...
| ---- | --------------------------------------- | -------------- | ------------------------------------------------------- | ---------------------------------------------- | ------------- | ---------- | -------- |
| W0   | Platform Foundation                     | S0             | NFR-03, 06, 12–13; FR-CC-01–03, 16–17                   | None                                           | `In Validation` | Platform   | [Local, CI, and Railway evidence](../validation/w0-platform-foundation.md) |
